...
if(!port){
<<<<<<< HEAD
  console.log('请指定端口号好不啦？\nnode server.js 9990 这样不会吗？')
=======
  console.log('请指定端口号好不啦？\nnode server.js 8888 这样不会吗？')
>>>>>>> 2287469c2daab0b445fce46205ff73e22800e479
  process.exit(1)
}
...
<<<<<<< HEAD
    ...
    response.write(fs.readFileSync('./public/shu.js'))
    response.end()
=======
  } else if(path === '/qq.js'){
    response.statusCode = 200
    ...
    if(request.headers['referer'].indexOf('http://127.0.0.1:9990')===0){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/javascript;charset=utf-8')
